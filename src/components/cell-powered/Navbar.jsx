...
export default function Navbar() {
   return (
      <div className="flex fixed top-0 left-0 right-0 z-50 justify-center max-w-4xl mx-auto">
         <div className="navbar backdrop-blur-2xl flex-nowrap bg-green-400/10 rounded-4xl overflow-hidden w-[80vw] min-w-60 my-8 grain-bg [--grain-opacity:0.2] border border-white/20">
