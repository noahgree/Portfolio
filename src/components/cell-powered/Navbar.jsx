...
export default function Navbar() {
	return (
		<div className="flex fixed top-0 left-0 right-0 z-50 justify-center max-w-3xl mx-auto">
			<div className="navbar backdrop-blur-2xl flex-nowrap rounded-4xl overflow-hidden w-[80vw] min-w-60 my-8 bg-white/5 border border-white/10">
				...
				<div className="navbar-end mx-1">
					<a
						className="btn rounded-4xl btn-soft bg-white/5 hover:bg-white/10 hidden sm:inline-flex text-dim-white"
					...
					<a
						className="btn btn-circle btn-soft bg-white/5 hover:bg-white/10 sm:hidden"
						href="https://github.com/noahgree/cellpowered-updates/releases/latest/download/Cell.Powered.dmg"
					>
